...
public class ClassUtil {
    ...
    public static Object[] getColumnsFrooModel(Class modelClass, String[] ignoreFields) throws Exception{

        List<java.lang.reflect.Field> fields = ClassUtil.getAllFields(modelClass);
        ...
        for(java.lang.reflect.Field it : fields){
            ...
            if(contains(ignoreFields, name))
                continue;

            Class type = it.getType();
            String typeName = getTypeName(type);
            items[i++] = name + "#" + typeName;
        }
